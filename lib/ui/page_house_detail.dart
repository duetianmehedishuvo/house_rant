            ...
            Align(
              ...
              child: GestureDetector(
                child: Row(
                  ...
                  children: <Widget>[
                    Icon(FontAwesomeIcons.mapMarkerAlt, size: 12.0),
                    Text(
                          ...
                          child: ClipOval(
                            child: Container(
                              ...
                              child: new RawMaterialButton(
                                ...
                                child: new Icon(
                                  Icons.favorite,
                                  color: (_fireStatus) ? Colors.blue[700] : Colors.grey,
                                ),
                                onPressed: () {
                                  setState(() {
                                  ...
                                  Fluttertoast.showToast(
                                      msg: (_fireStatus) ? "Added to Favorites" : "Removed from Favorites",
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Center(
                            child: IconButton(
                              tooltip: "Call",
                              icon: Icon(FontAwesomeIcons.phoneAlt, size: 17, color: Colors.white),
                              onPressed: () async {
                        ...
                        Container(
                          ...
                          child: Center(
                            child: IconButton(
                                tooltip: "Chat",
                                icon: Icon(FontAwesomeIcons.solidComment, size: 17, color: Colors.white),
                                onPressed: () async {
                        ...
                        Container(
                          ...
                          child: Center(
                            child: IconButton(
                              tooltip: "Pay Rent",
                              icon: Icon(FontAwesomeIcons.wallet, size: 17, color: Colors.white),
                              onPressed: () async {
                                Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentPage(ownerSnapshot)));
                              },
                            ),
                          ),
                        ),
      ...
      child: Row(
        children: <Widget>[
          ...
          ResponsiveContainer(
            ...
            heightPercent: 10,
            child: Container(
              decoration: BoxDecoration(border: Border(left: BorderSide(color: Colors.grey, width: 2.0))),
              child: Column(
                children: <Widget>[
                  Container(
  ...
  Widget getFifthCard() {
    return Center(
      child: Card(
        elevation: 6,
        child: Container(
            padding: new EdgeInsets.fromLTRB(15, 16, 10, 16),
            child: Column(
              children: <Widget>[
                Align(
                  alignment: Alignment.centerLeft,
                          ...
                          children: <Widget>[
                            ResponsiveContainer(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Icon(FontAwesomeIcons.bed, color: Colors.black.withOpacity(0.6), size: 18),
                                    SizedBox(width: 8),
                                    Text(
                            ...
                            ResponsiveContainer(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Icon(FontAwesomeIcons.solidHeart, color: Colors.black.withOpacity(0.6), size: 18),
                                    SizedBox(width: 8),
                                    Text(
                            ...
                            ResponsiveContainer(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Icon(FontAwesomeIcons.home, color: Colors.black.withOpacity(0.6), size: 18),
                                    SizedBox(width: 8),
                                    Text(
                                      //'Apartment',
                          ...
                          children: <Widget>[
                            ResponsiveContainer(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Icon(FontAwesomeIcons.toilet, color: Colors.black.withOpacity(0.6), size: 18),
                                    SizedBox(width: 8),
                                    Expanded(
                                      child: Text(
                            ...
                            ResponsiveContainer(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Icon(FontAwesomeIcons.calendarAlt, color: Colors.black.withOpacity(0.6), size: 18),
                                    SizedBox(width: 8),
                                    Expanded(
                                      child: Text(
                                        DateFormat('dd/MM/yyyy')
                                            .format((snapshot['Date Created'] as Timestamp).toDate())
                                            .toString(),
                                        overflow: TextOverflow.ellipsis,
                                        style: TextStyle(
                                          color: Colors.black.withOpacity(0.6),
                            ...
                            ResponsiveContainer(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Icon(FontAwesomeIcons.key, color: Colors.black.withOpacity(0.6), size: 18),
                                    SizedBox(width: 8),
                                    Text(
                                      snapshot['status'],
                                      style: TextStyle(
            ...
            child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Wrap(
                      children: <Widget>[for (var i in snapshot['Facilities']) getFacility(i)],
                    )
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffE6B15C), Color(0xffFFF84E)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffFFB849), Color(0xffD20B54)])),
              child: Image.asset(
                'assets/icons/ac.png',
                width: 45,
              ),
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xff76BAFF), Color(0xff4EFFF8)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xff3A40EE), Color(0xffF747AB)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffff74a4), Color(0xffCA54D4)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xff2BFBED), Color(0xffD9E021)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffFBBF36), Color(0xffF88D44)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffC8E234), Color(0xff6AEB34)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xff77A5F8), Color(0xffD5A3FF)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffB26FEC), Color(0xff22E6B9)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffB4FF4E), Color(0xff2FC145)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xffFCCF31), Color(0xffF55555)])),
              child: Image.asset(
        ...
        return Padding(
          ...
          child: ClipOval(
            child: Container(
              ...
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Color(0xff60FF04), Color(0xff23EDED)])),
              child: Image.asset(
                        ...
                        child: FlatButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                                context, MaterialPageRoute(builder: (_) => MultiImage(snapshot.id, snapshot)));
                          },
                          child: Center(
                              child: Text(
                            "ADD HOUSE IMAGES",
                            style: TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'Ex02'),
                          )),
                        ),
                      ),
                    )
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: ownerSnapshot.data().containsKey("profileImage")
                            ? Image.network('${ownerSnapshot['profileImage']}')
                          ...
                          children: <Widget>[
                            ...
                            Align(
                              ...
                              child: Text("${ownerSnapshot['email']}",
                                  textAlign: TextAlign.left, style: TextStyle(color: Colors.grey, fontSize: size.getWidthPx(15))),
                            )
                          ],
                        ),
                      ),
