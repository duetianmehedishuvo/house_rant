...
List<String> roomList = <String>['1BHK', '2BHK', '3BHK', '4BHK', '4+BHK'];
...
class CustomSearchState extends State<CustomSearchPage> {
  ...
  String _lowerValueString = NumberFormat.compactCurrency(decimalDigits: 0, symbol: '৳').format(_minlowerValue * 1000);
  static double _maxupperValue = 100.0;
  String _upperValueString = NumberFormat.compactCurrency(decimalDigits: 0, symbol: '৳').format(_maxupperValue * 1000);
  String _upperValueFormatted = NumberFormat.compactCurrency(decimalDigits: 0, symbol: '৳').format(_upperValue * 1000);

  String _lowerValueFormatted = NumberFormat.compactCurrency(decimalDigits: 0, symbol: '৳').format(_lowerValue * 1000);
  ...
  void _search() async {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (_) => SearchResultPage(userRef, searchController.text, (_upperValue * 100).toString())));
    ...
    return Padding(
      ...
      child: Transform(
        ...
        child: InputChip(
          ...
          labelStyle:
              TextStyle(fontFamily: 'Exo2', color: (_selectedProperty.contains(index)) ? backgroundColor : textPrimaryColor),
          elevation: 4.0,
          padding: EdgeInsets.symmetric(vertical: size.getWidthPx(4), horizontal: size.getWidthPx(12)),
              ...
              Container(
                ...
                child: FlatButton(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Exo2',
                      color: _selectedRoom.contains("1RK") ? backgroundColor : textPrimaryColor,
                    ),
                  ),
                  onPressed: () {
                    FocusScope.of(context).requestFocus(new FocusNode());
              ...
              Container(
                ...
                child: FlatButton(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Exo2',
                      color: _selectedRoom.contains("1BHK") ? backgroundColor : textPrimaryColor,
                    ),
                  ),
                  onPressed: () {
                    FocusScope.of(context).requestFocus(new FocusNode());
              ...
              Container(
                ...
                child: FlatButton(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Exo2',
                      color: _selectedRoom.contains("2BHK") ? backgroundColor : textPrimaryColor,
                    ),
                  ),
                  onPressed: () {
                    FocusScope.of(context).requestFocus(new FocusNode());
              ...
              Container(
                ...
                child: FlatButton(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Exo2',
                      color: _selectedRoom.contains("3BHK") ? backgroundColor : textPrimaryColor,
                    ),
                  ),
                  onPressed: () {
                    FocusScope.of(context).requestFocus(new FocusNode());
              ...
              Container(
                ...
                child: FlatButton(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Exo2',
                      color: _selectedRoom.contains("4BHK") ? backgroundColor : textPrimaryColor,
                    ),
                  ),
                  onPressed: () {
                    FocusScope.of(context).requestFocus(new FocusNode());
              ...
              Container(
                ...
                child: FlatButton(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Exo2',
                      color: _selectedRoom.contains("4+BHK") ? backgroundColor : textPrimaryColor,
                    ),
                  ),
                  onPressed: () {
                    FocusScope.of(context).requestFocus(new FocusNode());
  ...
  Widget _buildRangeSlider() {
    return frs.RangeSlider(
      ...
      valueIndicatorFormatter: (int index, double value) {
        String twoDecimals = NumberFormat.compactCurrency(decimalDigits: 0, symbol: '৳').format(value * 1000);
        return '$twoDecimals';
      },
      onChanged: (double newLowerValue, double newUpperValue) {
        ...
        setState(() {
          ...
          _upperValueFormatted = NumberFormat.compactCurrency(decimalDigits: 0, symbol: '৳').format(_upperValue * 1000);
          _lowerValueFormatted = NumberFormat.compactCurrency(decimalDigits: 0, symbol: '৳').format(_lowerValue * 1000);
        });
      },
    );
  }
    ...
    return ClipRRect(
      ...
      child: Container(
        ...
        child: FlatButton(
          child: Text(
            "SEARCH",
            style: TextStyle(fontFamily: 'Exo2', color: Colors.white, fontSize: size.getWidthPx(20)),
          ),
          onPressed: () {
            FocusScope.of(context).requestFocus(new FocusNode());
  ...
  Card preferenceUpperBoxCard() {
    return Card(
        ...
        margin: EdgeInsets.symmetric(horizontal: size.getWidthPx(12), vertical: size.getWidthPx(12)),
