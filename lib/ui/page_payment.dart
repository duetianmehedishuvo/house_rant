...
class _PaymentPageState extends State<PaymentPage> {
                    ...
                    onTap: () {
                      showDatePicker(
                        ...
                        if (value != null && _lastDate == null) {
                          setState(() {
                            _startDate = new DateFormat('dd-MM-yyyy').format(value);
                            _sdate = value;
                          });
                    ...
                    onTap: () {
                      showDatePicker(
                        ...
                        if (value != null && _startDate != null) {
                          (value.difference(_sdate).inSeconds > 0)
                              ? setState(() {
                                  _lastDate = new DateFormat('dd-MM-yyyy').format(value);
                                  _ldate = value;
                                })
                  ...
                  child: Container(
                    ...
                    child: FlatButton(
                      ...
                      child: Center(
                          child: Text(
                        "PROCEED FOR PAYMENT",
                        style: TextStyle(color: Colors.white, fontSize: size.getWidthPx(20), fontFamily: 'Ex02'),
                      )),
                    ),
                    height: size.hp(8),
                  ),
  ...
  String validateAddress(String value) {
    ...
    if (!nameExp.hasMatch(value)) return 'Address can only contain [ 0-9 A-Z a-z . - \\ / ] only';
    return null;
  }
  ...
  String validateCity(String value) {
    ...
    final RegExp nameExp = new RegExp(r'^[A-Za-z0-9-,./\\[\] ]+$');
    if (!nameExp.hasMatch(value)) return 'City can contain [ 0-9 A-Z a-z . - \\ / ] only';
    return null;
  }
  ...
  void openCheckout() async {
    var options = {
      ...
      'name': _name,
      'description':
          _propertyName.length > 31 ? 'House rent for ' + _propertyName.substring(1, 30) : 'House rent for ' + _propertyName,
  ...
  void _handlePaymentSuccess(PaymentFailureResponse response) {
